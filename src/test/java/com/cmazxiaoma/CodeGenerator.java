...
import static com.cmazxiaoma.core.ProjectConstant.*;
...
public class CodeGenerator {
    ...
    private static final String JDBC_PASSWORD = "xiaoma";
    ...
    //@author
    private static final String AUTHOR = "cmazxiaoma";
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            data.put("baseCorePackage", BASE_CORE_PACKAGE);

            File file = new File(PROJECT_PATH + JAVA_PATH + PACKAGE_PATH_SERVICE + modelNameUpperCamel + "IService.java");
            if (!file.getParentFile().exists()) {
                file.getParentFile().mkdirs();
            }
            cfg.getTemplate("service.ftl").process(data,
                    new FileWriter(file));
            System.out.println(modelNameUpperCamel + "IService.java 生成成功");
